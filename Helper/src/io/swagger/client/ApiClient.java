...
public class ApiClient {
    ...
    private String basePath = "https://esi.tech.ccp.is/legacy";
...
//        authentications.put("evesso", new HttpBasicAuth());
        authentications.put("evesso", new ApiKeyAuth("header","Authorization"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://esi.tech.ccp.is/legacy
